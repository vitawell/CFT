...
def train_rgb_ir(hyp, opt, device, tb_writer=None):
    ...
    train_path_3 = data_dict['train_3']
    test_path_3 = data_dict['val_3']
    ...
    # ============================================== 4、数据加载 ===============================================
    # Trainloader
    dataloader, dataset = create_dataloader_3(train_path_rgb, train_path_ir, train_path_3, imgsz, batch_size, gs, opt,
    ...
    # Process 0
    if rank in [-1, 0]:
        testloader, testdata = create_dataloader_3(test_path_rgb, test_path_ir, test_path_3,imgsz_test, batch_size * 2, gs, opt,  # testloader
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            with amp.autocast(enabled=cuda):
                ...
                for j in range(3): #3个特征图
                    for k in range(1,len(pred)): #concat pred1和pred2到pred0
...
#                 #loss_items = loss_items1* a + loss_items2 * b
#                 a,b,c = 0.5, 0.5, 0.5  #loss权重
#                 loss = loss1 * a + loss2 * b + loss3 * c
#                 loss_items = loss_items1* a + loss_items2 * b + loss_items3 * c
        ...
        if rank in [-1, 0]:
            ...
            if not opt.notest or final_epoch:  # Calculate mAP
                ...
                results, maps, times = test3c.test(data_dict,
