...
class Detect(nn.Module):
    stride = None  # strides computed during build  ##只实例化了最后一个detect？
    ...
    def forward(self, x):
        ...
        for i in range(self.nl):
            ...
            if not self.training:  # inference
                ...
                #print(self.stride[i])  #报错 'NoneType' object is not subscriptable
...
class Model(nn.Module):
    ...
    def forward(self, x, x2, x3, augment=False, profile=False):
        ...
        # 默认执行 正常前向推理
            ...
            x,dout = self.forward_once(x, x2, x3, profile)
    ...
    def forward_once(self, x, x2, x3, profile=False):
        """
